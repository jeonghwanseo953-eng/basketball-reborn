...
@Entity
@Table(name = "game_days", indexes = {
	@Index(name = "idx_game_days_status_date_time", columnList = "status, gameDate, startTime"),
	@Index(name = "idx_game_days_date", columnList = "gameDate")
})
