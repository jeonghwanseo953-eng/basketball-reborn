...
@Table(name = "fee_payments", indexes = {
	@Index(name = "idx_fee_payments_month", columnList = "fee_month_id"),
	@Index(name = "idx_fee_payments_month_status", columnList = "fee_month_id, status"),
	@Index(name = "idx_fee_payments_member", columnList = "member_id")
})
